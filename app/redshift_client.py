...
def execute_query(sql: str, target_name: str, max_rows: int) -> Dict[str, Any]:
    """Execute a SELECT query against Redshift and return normalized results."""
    ...
    try:
        ...
        raise RuntimeError(f"Redshift query failed: {e}") from e
